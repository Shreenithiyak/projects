  ...
  return (
    <div className="min-h-screen p-10 bg-gray-50">
      <div className="flex gap-4 mb-8 justify-center">
        <button onClick={() => navigate("/")} className="px-4 py-2 bg-gray-500 text-white rounded">Introduction</button>
        <button onClick={() => navigate("/createphase")} className="px-4 py-2 bg-blue-500 text-white rounded">Create Phase</button>
        <button onClick={() => navigate("/updatephase")} className="px-4 py-2 bg-purple-500 text-white rounded">Update Phase</button>
      </div>
